export const ELEMENT_IDS = {
  ...
  BUTTON_DEPOSIT_CONFIRMATION_START: 'btn-deposit-confirmation-start',
  PAGE_DEPOSIT_CONFIRMATION: 'page-deposit-confirmation',
  SUMMARY_DEPOSIT_CONFIRMATION: 'summary-deposit-confirmation',
  NOTICE_DEPOSIT_CONFIRMATION: 'notice-deposit-confirmation',
  STATUS_DEPOSIT_FINAL_APPROVAL: 'status-deposit-final-approval',
  BUTTON_DEPOSIT_CONFIRMATION_BACK: 'btn-deposit-confirmation-back',
  PAGE_DEPOSIT_COMPLETION: 'page-deposit-completion',
  STATUS_DEPOSIT_DEMO_COMPLETION: 'status-deposit-demo-completion',
  NOTICE_DEPOSIT_NO_TRANSACTION: 'notice-deposit-no-transaction',
  BUTTON_DEPOSIT_HOME: 'btn-deposit-home',
  ...
  SUMMARY_TRANSFER_PASSWORD_SOURCE_ACCOUNT:
    'summary-transfer-password-source-account',
  SUMMARY_TRANSFER_PASSWORD_RECIPIENT:
    'summary-transfer-password-recipient',
  INPUT_ACCOUNT_PASSWORD: 'input-account-password',
  STATUS_TRANSFER_PASSWORD_INPUT:
    'status-transfer-password-input',
  STATUS_CONFIRMED_TRANSFER_PASSWORD:
    'status-confirmed-transfer-password',
